...
| # | タスク名 | 概要 | 依存 | 状態 |
|---|---------|------|------|------|
| 1 | 環境構築 | Next.js + Tailwind + shadcn/ui + Supabase設定 | - | ✅ 完了 |
| 2 | 共通基盤 | 型定義、共通コンポーネント、レイアウト | 1 | ✅ 完了 |
| 3 | データベース | Supabase: テーブル作成、RLS設定 | 1 | ✅ 完了 |
| 4 | 公開画面（基本） | トップページ、詳細ページ、ベース別一覧 | 2, 3 | ✅ 完了 |
| 5 | 公開画面（追加） | お気に入り、サイト説明、404、検索モーダル | 4 | 🔜 次 |
